...
Route::group(['prefix' => 'services'], function () {
    ...
    Route::get('/', function () {
        ...
        // Creative Services detail (dynamically routed from the grand unveil)
        Route::get('/creative/{slug}', function ($slug) {
            return view('pages.services.creative-detail', compact('slug'));
        }
        )->name('services.creative.show');

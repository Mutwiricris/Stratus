...
<section class="py-20 md:py-28 bg-gradient-to-br from-gray-50 to-turquoise-50/30 px-8">
  <div class="max-w-7xl mx-auto">
    <div class="text-center mb-16 fade-in-up">
      <h2 class="font-serif text-4xl md:text-5xl font-bold text-dark-turquoise mb-4">Experience the App</h2>
    ...
    <div class="grid lg:grid-cols-2 gap-12 items-center mb-20">
      <div class="fade-in-up">
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div class="p-6">
            <h3 class="font-serif text-2xl font-bold text-dark-turquoise mb-2">Player Dashboard</h3>
      ...
      <div class="fade-in-up" style="transition-delay: 200ms;">
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div class="p-6">
            <h3 class="font-serif text-2xl font-bold text-dark-turquoise mb-2">Match Management</h3>
...
<section id="features" class="py-20 md:py-28 px-8">
  <div class="max-w-7xl mx-auto">
    <div class="text-center mb-16 fade-in-up">
      <h2 class="font-serif text-4xl md:text-5xl font-bold text-dark-turquoise mb-4">Everything Pool Players Need</h2>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-white rounded-2xl p-8 shadow-lg card-hover fade-in-up">
        ...
        <h3 class="font-serif text-2xl font-bold text-dark-turquoise mb-4">Smart Match Management</h3>
      ...
      <div class="bg-white rounded-2xl p-8 shadow-lg card-hover fade-in-up" style="transition-delay: 100ms;">
        ...
        <h3 class="font-serif text-2xl font-bold text-dark-turquoise mb-4">Tournament Organization</h3>
      ...
      <div class="bg-white rounded-2xl p-8 shadow-lg card-hover fade-in-up" style="transition-delay: 200ms;">
        ...
        <h3 class="font-serif text-2xl font-bold text-dark-turquoise mb-4">Player Rankings</h3>
      ...
      <div class="bg-white rounded-2xl p-8 shadow-lg card-hover fade-in-up" style="transition-delay: 300ms;">
        ...
        <h3 class="font-serif text-2xl font-bold text-dark-turquoise mb-4">Community Features</h3>
      ...
      <div class="bg-white rounded-2xl p-8 shadow-lg card-hover fade-in-up" style="transition-delay: 400ms;">
        ...
        <h3 class="font-serif text-2xl font-bold text-dark-turquoise mb-4">Performance Analytics</h3>
      ...
      <div class="bg-white rounded-2xl p-8 shadow-lg card-hover fade-in-up" style="transition-delay: 500ms;">
        ...
        <h3 class="font-serif text-2xl font-bold text-dark-turquoise mb-4">Venue Integration</h3>
...
<section id="download" class="py-20 md:py-28 px-8 bg-gradient-to-br from-dark-turquoise to-turquoise-600">
  <div class="max-w-4xl mx-auto text-center">
    <div class="fade-in-up">
      <h2 class="font-serif text-4xl md:text-5xl font-bold text-white mb-6">Join the Pool Community Today</h2>

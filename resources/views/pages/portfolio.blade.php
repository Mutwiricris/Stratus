...
<section class="relative min-h-[70vh] flex items-center">
  <div class="absolute inset-0">
    <img src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=2070" alt="Portfolio" class="w-full h-full object-cover">
    ...
    <div class="max-w-4xl">
      <div class="fade-in-up">
        ...
        <div class="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
          <a href="#ventures" class="bg-cyan-300 text-dark-turquoise px-6 sm:px-8 py-3 sm:py-4 rounded-lg text-base sm:text-lg font-semibold btn-animate shadow-lg hover:bg-white hover:text-dark-turquoise transition-colors">
            View Ventures
          </a>
          <a href="#case-studies" class="text-white/90 hover:text-white font-medium border-b border-white/40 hover:border-cyan-300 transition-all duration-300 py-2">
            Case Studies
          </a>
        </div>
      </div>

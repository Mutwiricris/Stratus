    ...
    <div class="grid lg:grid-cols-2 min-h-[600px]">
      ...
      <div class="p-8 lg:p-12 flex flex-col justify-center">
        ...
        <p class="text-lg text-gray-600 mb-8 leading-relaxed">
          Join <strong>500+ successful businesses</strong> across Africa who have revolutionized their operations with our enterprise software, fintech solutions, and mobile applications.
        </p>

    ...
    <div class="max-w-7xl mx-auto px-8 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="{{ url('/about') }}" class="text-cyan-100 hover:text-white transition-colors">About Us</a></li>
                    <li><a href="{{ url('/platform') }}" class="text-cyan-100 hover:text-white transition-colors">Our Platform</a></li>
                    <li><a href="{{ url('/ventures') }}" class="text-cyan-100 hover:text-white transition-colors">Ventures</a></li>
                    <li><a href="{{ url('/careers') }}" class="text-cyan-100 hover:text-white transition-colors">Careers</a></li>
                    <li><a href="{{ url('/insights') }}" class="text-cyan-100 hover:text-white transition-colors">News & Insights</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="{{ url('/solutions') }}#logistics" class="text-cyan-100 hover:text-white transition-colors">Logistics & Supply Chain</a></li>
                    <li><a href="{{ url('/solutions') }}#fintech" class="text-cyan-100 hover:text-white transition-colors">Financial Technology</a></li>
                    <li><a href="{{ url('/solutions') }}#agritech" class="text-cyan-100 hover:text-white transition-colors">AgriTech Solutions</a></li>
                    <li><a href="{{ url('/solutions') }}#energy" class="text-cyan-100 hover:text-white transition-colors">Energy & Utilities</a></li>
                    <li><a href="{{ url('/solutions') }}#custom" class="text-cyan-100 hover:text-white transition-colors">Custom Solutions</a></li>
                </ul>
            </div>
        </div>
